...
public class Site extends DModelEntity {
    ...
    @Column(name = "calltracking_site_id")
    private Integer callTrackingSiteId;
    ...
    public Integer getCallTrackingSiteId() {
        return callTrackingSiteId;
    }

    public void setCallTrackingSiteId(Integer callTrackingSiteId) {
        this.callTrackingSiteId = callTrackingSiteId;
    }
}

package com.berzellius.integrations.astraestate;
...
@ComponentScan(
        excludeFilters = {
             //!включить все BatchConfiguration @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = CallsImportBatchConfiguration.class)
